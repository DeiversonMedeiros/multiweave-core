-- =====================================================
-- MIGRAÇÃO: Atualizar função criar_pedido para incluir condições de pagamento
-- Data: 2026-01-21
-- Descrição: Propaga condições de pagamento da cotação para o pedido
-- =====================================================
    ...
    IF NEW.status = 'aprovada' 
       ...
       AND (OLD.status IS NULL OR OLD.status != 'aprovada' OR OLD.workflow_state != 'aprovada') THEN
        ...
        LOOP
            ...
            -- ✅ NOVO: Criar pedido de compra com condições de pagamento
            INSERT INTO compras.pedidos_compra (
                ...
                'aberto',
                -- ✅ NOVOS VALORES: Condições de pagamento do fornecedor
...
'Cria pedido de compra e conta a pagar automaticamente quando cotação é aprovada. Inclui propagação de condições de pagamento.';
