-- =====================================================
-- CORREÇÃO: get_entity_data para tabelas sem company_id
-- Data: 2025-11-09
-- Descrição: Verifica se a tabela tem coluna company_id antes de filtrar
--             Permite buscar dados em tabelas de relacionamento (ex: employee_location_zones)
-- =====================================================
...
DECLARE
    ...
    base_field text;
    condition text;
    has_company_id_column boolean := false; -- Nova variável
BEGIN
    -- Log de entrada
...
'Função genérica para buscar dados. Verifica se a tabela tem company_id antes de filtrar. Permite buscar dados em tabelas de relacionamento.';
