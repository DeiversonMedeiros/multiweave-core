-- =====================================================
-- CORREÇÃO: get_required_approvers - Remover referência a departamento
-- Data: 2025-01-31
-- Descrição: Remove a comparação com departamento para requisicoes_compra
--            já que essa coluna não existe na tabela
-- =====================================================
...
'Determina os aprovadores necessários para um processo. Para requisições de compra, ignora o filtro de departamento pois essa coluna não existe na tabela.';
