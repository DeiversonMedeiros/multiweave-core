-- =====================================================
-- CORREÇÃO CRÍTICA: NUNCA ZERAR DADOS EXISTENTES
-- =====================================================
-- Problema: A função recalculate_time_record_hours zera os dados
-- quando não encontra eventos de ponto, mesmo que os dados já existam
-- na tabela time_records (entrada, saida, etc).
-- 
-- Solução: Usar dados existentes na tabela time_records como fonte primária.
-- Só usar eventos se disponíveis, mas NUNCA zerar dados existentes.
-- =====================================================
