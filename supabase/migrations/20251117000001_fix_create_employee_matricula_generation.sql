-- =====================================================
-- CORRIGIR GERAÇÃO AUTOMÁTICA DE MATRÍCULA EM create_employee
-- Data: 2025-11-17
-- Descrição: Reintroduz a geração automática de matrícula usando
--            public.generate_employee_matricula quando o campo não
--            for informado ou vier vazio.
-- =====================================================
...
BEGIN
  ...
  -- Garantir geração automática da matrícula
  IF matricula_param IS NULL OR btrim(matricula_param) = '' THEN
    matricula_to_use := public.generate_employee_matricula(company_id_param);
  ELSE
    matricula_to_use := matricula_param;
  END IF;
  ...
  INSERT INTO rh.employees (
    ...
    new_employee_id, company_id_param, nome_param, matricula_to_use, cpf_param, rg_param,
