-- =====================================================
-- CORREÇÃO: CONVERSÃO DE TIPO NA FUNÇÃO get_pending_approvals_for_user
-- =====================================================
-- Data: 2025-12-06
-- Descrição: Corrige o erro de tipo na coluna 9 (horas)
--            A coluna quantidade_horas é NUMERIC(5,2) e precisa ser convertida para INTEGER
-- =====================================================
...
BEGIN
    ...
    (
        ...
        -- Compensações pendentes (CORRIGIDO: converte NUMERIC para INTEGER)
        SELECT 
            cr.id,
...
'Retorna aprovações pendentes para um usuário. Corrigido: converte quantidade_horas (NUMERIC) para INTEGER usando FLOOR()';
