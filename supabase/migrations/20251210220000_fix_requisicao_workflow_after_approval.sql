-- =====================================================
-- CORREÇÃO: Requisições aprovadas devem ir direto para 'em_cotacao'
-- Data: 2025-12-10
-- Descrição: Após aprovação completa, requisição deve ir para 'em_cotacao'
--   para que o comprador possa fazer as cotações conforme regra de negócio
-- =====================================================
...
COMMENT ON FUNCTION public.process_approval IS 'Processa aprovação e atualiza workflow_state para em_cotacao quando requisição é totalmente aprovada';
