-- Copiar TODOS os Centros de Custo da empresa de referência para as empresas destino
DO $$
DECLARE
...
BEGIN
    ...
    LOOP
        ...
        -- Copiar TODOS os registros da referência (evitando duplicatas por código)
