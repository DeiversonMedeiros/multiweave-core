-- =====================================================
-- SCRIPT PARA COPIAR CONFIGURAÇÕES DO BANCO DE HORAS (bank_hours_types)
...
SELECT id, name, code, is_default, is_active FROM rh.bank_hours_types WHERE company_id = 'dc060329-50cd-4114-922f-624a6ab036d6' ORDER BY name LIMIT 10;
