-- =====================================================
-- Adicionar filtro de gestor na função get_time_records_paginated
-- Permite que gestores vejam apenas registros de seus subordinados
-- =====================================================

-- Remover a função antiga (sem o parâmetro manager_user_id_filter)
...
-- Criar a nova função com o parâmetro adicional
