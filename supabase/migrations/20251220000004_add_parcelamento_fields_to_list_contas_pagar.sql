-- =====================================================
-- CORREÇÃO: Adicionar campos de parcelamento e urgência à função RPC
-- Data: 2025-12-20
-- Descrição: Adiciona campos is_parcelada, numero_parcelas, intervalo_parcelas,
--            is_urgente e motivo_urgencia à função list_contas_pagar_with_approval_status
-- =====================================================
...
COMMENT ON FUNCTION public.list_contas_pagar_with_approval_status(UUID) IS 'Lista contas a pagar com status de aprovação agregado e campos de parcelamento/urgência. Atualizada em 2025-12-20 para incluir is_parcelada, numero_parcelas, intervalo_parcelas, is_urgente e motivo_urgencia.';
