-- =====================================================
-- ADICIONAR LOGS NA FUNÇÃO get_managed_employees_bank_hours
-- =====================================================
...
BEGIN
  -- Log: Contar funcionários que atendem os critérios
  ...
  RAISE NOTICE '[get_managed_employees_bank_hours] Total funcionários encontrados: %', v_debug_count;
  RAISE NOTICE '[get_managed_employees_bank_hours] p_user_id: %, p_company_id: %', p_user_id, p_company_id;
