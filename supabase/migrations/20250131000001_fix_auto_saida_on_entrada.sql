...
NUNCA define saida automaticamente quando só há entrada.
...
Calcula horas parciais quando há entrada mas não saída explícita, usando o último evento do dia como referência para cálculo, mas NÃO define como saída.';
