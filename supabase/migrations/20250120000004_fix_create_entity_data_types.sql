-- =====================================================
-- CORREÇÃO FINAL DA FUNÇÃO create_entity_data - TIPOS
-- =====================================================
-- Data: 2025-01-20
-- Descrição: Versão que trata tipos corretamente (UUID, JSONB, etc.)

-- Função para criar dados em qualquer schema (versão com tratamento de tipos)
...
COMMENT ON FUNCTION create_entity_data IS 'Função para criar dados em qualquer schema com tratamento correto de tipos';
