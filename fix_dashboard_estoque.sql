-- =====================================================
-- CORREÇÃO DA VIEW DASHBOARD ESTOQUE
-- =====================================================
-- Data: 2025-01-15
-- Descrição: Corrige a view do dashboard de estoque mínimo
-- =====================================================
...
SELECT 
    ...
    AVG(CASE 
        WHEN me.quantidade_minima > 0 THEN ea.quantidade_atual / me.quantidade_minima 
        ELSE 1 
