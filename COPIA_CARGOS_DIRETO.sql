-- =====================================================
-- SCRIPT DIRETO PARA COPIAR CARGOS
...
SELECT id, nome, nivel_hierarquico, is_active FROM rh.positions WHERE company_id = 'dc060329-50cd-4114-922f-624a6ab036d6' ORDER BY nome LIMIT 10;
...
-- 3. COPIAR DADOS - Usando abordagem mais direta
