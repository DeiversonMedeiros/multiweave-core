-- =====================================================
-- CORREÇÃO DO EXECUTE USING NA FUNÇÃO create_entity_data
-- =====================================================
-- Data: 2025-01-20
-- Descrição: Correção do erro "cannot cast type text[] to uuid"

-- Função para criar dados em qualquer schema (versão corrigida para EXECUTE USING)
...
-- Função para atualizar dados em qualquer schema (versão corrigida para EXECUTE USING)
