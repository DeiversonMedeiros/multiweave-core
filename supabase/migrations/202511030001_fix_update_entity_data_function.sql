-- =====================================================
-- CORREÇÃO DA FUNÇÃO update_entity_data
-- Data: 2025-11-03
-- Descrição: Corrige e garante que a função update_entity_data está acessível via REST API
-- =====================================================

-- Remover a função existente para recriar
DROP FUNCTION IF EXISTS public.update_entity_data(text, text, uuid, uuid, jsonb);

-- Função para atualizar dados em qualquer schema (versão corrigida com tratamento de tipos)
...
'Atualiza dados em qualquer tabela de qualquer schema. Requer company_id e id como parâmetros para segurança. Retorna o registro atualizado como JSONB.';
