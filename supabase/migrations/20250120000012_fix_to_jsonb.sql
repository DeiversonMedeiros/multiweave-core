-- =====================================================
-- CORREÇÃO FINAL - TROCA DE to_jsonb() POR row_to_json()
-- =====================================================
-- Data: 2025-01-20
-- Descrição: Correção final trocando to_jsonb() por row_to_json()

-- Função para criar dados em qualquer schema (versão final com row_to_json)
...
-- Função para atualizar dados em qualquer schema (versão final com row_to_json)
