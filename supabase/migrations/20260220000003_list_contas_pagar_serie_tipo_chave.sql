-- Incluir serie_nota_fiscal, tipo_documento_fiscal e chave_acesso na list_contas_pagar_with_approval_status
...
RETURNS TABLE(
    ...
    tipo_documento_fiscal VARCHAR(50),
...
BEGIN
    ...
    SELECT
        ...
        cp.serie_nota_fiscal,
        cp.tipo_documento_fiscal,
        cp.chave_acesso,
        cp.valor_desconto,
        cp.valor_juros,
        cp.valor_multa,
...
COMMENT ON FUNCTION public.list_contas_pagar_with_approval_status(UUID) IS 'Lista contas a pagar com status de aprovação. Inclui serie_nota_fiscal, tipo_documento_fiscal e chave_acesso (2026-02-20).';
