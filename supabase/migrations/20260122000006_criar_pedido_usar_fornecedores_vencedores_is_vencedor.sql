-- =====================================================
-- FIX: Pedido/conta a pagar não gerados ao aprovar cotação
-- Data: 2026-01-22
-- Descrição: O trigger criar_pedido_apos_aprovacao_cotacao_ciclos filtrava por
--            cf.status = 'aprovada', mas esse status NUNCA é definido ao aprovar
--            a cotação. Os "vencedores" vêm de cotacao_item_fornecedor.is_vencedor.
--            Corrige para usar fornecedores com pelo menos um item is_vencedor=true,
--            calcular totais e copiar apenas itens vencedores por fornecedor.
-- Caso: COT-000048 aprovada, 0 pedidos gerados (todos cf.status = 'pendente').
-- =====================================================
...
'Cria pedido e conta a pagar ao aprovar cotação. Usa fornecedores VENCEDORES (is_vencedor em cotacao_item_fornecedor), não cf.status. Totais e itens apenas dos itens vencedores por fornecedor.';
