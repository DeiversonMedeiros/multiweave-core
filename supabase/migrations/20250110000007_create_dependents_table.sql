...
CREATE INDEX idx_dependents_company_id ON rh.dependents(company_id);
CREATE INDEX idx_dependents_employee_id ON rh.dependents(employee_id);
CREATE INDEX idx_dependents_parentesco ON rh.dependents(parentesco);
CREATE INDEX idx_dependents_status ON rh.dependents(status);
CREATE INDEX idx_dependents_cpf ON rh.dependents(cpf);
CREATE INDEX idx_dependents_data_nascimento ON rh.dependents(data_nascimento);
