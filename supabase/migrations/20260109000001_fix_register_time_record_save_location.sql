-- =====================================================
-- CORRIGIR FUNÇÃO RPC PARA SALVAR LOCALIZAÇÃO NA TABELA TIME_RECORDS
-- =====================================================
-- Data: 2026-01-09
-- Descrição: A função register_time_record estava salvando localização apenas
--            em time_record_events, mas não na tabela principal time_records.
--            Esta migração corrige isso para salvar também na tabela principal.
-- =====================================================

-- Remover versões antigas da função para evitar conflito de sobrecarga
DROP FUNCTION IF EXISTS public.register_time_record(uuid, uuid, text, timestamptz, text, numeric, numeric, numeric, text);
DROP FUNCTION IF EXISTS public.register_time_record(uuid, uuid, text, timestamptz, text, numeric, numeric, numeric, text, text);
...
'Registra ponto com timezone correto e localização.
