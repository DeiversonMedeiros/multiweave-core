-- =====================================================
-- CORREÇÃO PARA CARREGAR VÍNCULOS COM DADOS RELACIONADOS
-- =====================================================

-- Função para buscar vínculos com dados relacionados
CREATE OR REPLACE FUNCTION rh.get_bank_hours_assignments_with_relations(
  p_company_id UUID
)
RETURNS TABLE(
  id UUID,
...
CREATE OR REPLACE FUNCTION rh.get_type_bank_hours_assignments_with_relations(
  p_type_id UUID,
  p_company_id UUID
)
RETURNS TABLE(
...
GRANT EXECUTE ON FUNCTION rh.get_bank_hours_assignments_with_relations(UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION rh.get_bank_hours_assignment_with_relations(UUID, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION rh.get_employee_bank_hours_assignments_with_relations(UUID, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION rh.get_type_bank_hours_assignments_with_relations(UUID, UUID) TO authenticated;
