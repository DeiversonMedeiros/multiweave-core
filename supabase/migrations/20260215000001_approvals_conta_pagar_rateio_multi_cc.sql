-- =====================================================
-- MIGRAÇÃO: Aprovações para conta a pagar rateada e prioridade de classe
-- Data: 2026-02-15
-- Descrição:
--   1. Conta a pagar rateada: usar centros de custo do rateio (contas_pagar_rateio)
--   2. Prioridade classe financeira: config com centro_custo_id=NULL e classe específica
--      (ex: Folha de Pagamento) aplica independente do CC
--   3. Deduplicar aprovadores quando múltiplos CCs
-- =====================================================
...
BEGIN
    CASE p_processo_tipo
        WHEN 'conta_pagar' THEN
            ...
            -- Obter centros de custo: rateio ou conta principal
            ...
            -- Converter classe_financeira (VARCHAR) para UUID
            ...
            -- 1) PRIORIDADE: config com centro_custo_id IS NULL e classe específica (ex: Folha)
            --    Aplica independente dos centros de custo do rateio
            ...
            -- 2) Se sem centros de custo, tentar config genérica (centro_custo_id IS NULL)
            ...
            -- 3) Configs por centro de custo: iterar sobre cada CC do rateio/conta
    ...
    -- Fluxo original para tipos que não são conta_pagar
...
'Determina aprovadores. conta_pagar: suporta rateio (múltiplos CCs), prioridade para config com centro_custo_id=NULL e classe específica (ex: Folha). 2026-02-15.';
