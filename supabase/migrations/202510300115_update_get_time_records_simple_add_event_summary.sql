-- =====================================================
-- Update public.get_time_records_simple to include optional event-derived fields
-- Keeps existing columns and appends extra columns to avoid breaking current consumers
-- =====================================================
