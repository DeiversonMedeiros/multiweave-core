-- =====================================================
-- CORREÇÃO: Chamada is_rest_day em calculate_overtime_by_scale
-- =====================================================
-- A função rh.is_rest_day tem assinatura (p_employee_id, p_company_id, p_date).
-- Na migration 20260210000002 foi usada com 2 argumentos por engano.
-- Esta migration corrige a função no banco (para quem já aplicou a 20260210000002).
-- =====================================================
...
'Calcula horas extras conforme tipo de escala e regras CLT. CORREÇÃO 2026-02-10: is_rest_day com 3 args (employee_id, company_id, date). Limita excedente pela janela_tempo_marcacoes.';
