-- =====================================================
-- MIGRATION: Remover campo departamento da função list_contas_pagar_with_approval_status
-- =====================================================
-- Data: 2026-01-06
-- Descrição: Remove o campo "departamento" da função RPC list_contas_pagar_with_approval_status
-- Autor: Sistema MultiWeave Core
-- =====================================================

-- Remover a função existente antes de recriar sem o campo departamento
...
COMMENT ON FUNCTION public.list_contas_pagar_with_approval_status(UUID) IS 'Lista contas a pagar com status de aprovação agregado, campos de parcelamento/urgência e anexos (boleto e nota fiscal). Atualizada em 2026-01-06 para remover campo departamento.';
