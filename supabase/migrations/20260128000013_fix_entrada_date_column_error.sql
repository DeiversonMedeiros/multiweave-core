-- =====================================================
-- CORREÇÃO: Erro "column entrada_date does not exist"
-- =====================================================
-- Data: 2026-01-28
-- Descrição: A função recalculate_time_record_hours estava tentando buscar
--            campos *_date (entrada_date, saida_date, etc.) da tabela time_records,
--            mas esses campos não existem como colunas. Eles são apenas campos
--            calculados retornados pela função get_consolidated_time_record_by_window.
--            
--            Esta correção atualiza a função para calcular essas datas a partir
--            dos event_at dos eventos em vez de tentar buscá-las da tabela.
-- =====================================================
