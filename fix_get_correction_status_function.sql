-- =====================================================
-- CORREÇÃO: FUNÇÃO get_correction_status - Erro EXTRACT
-- =====================================================
-- Data: 2025-01-27
-- Descrição: Corrige o erro de EXTRACT na função get_correction_status
...
BEGIN
    ...
    -- A diferença entre duas datas retorna um integer (número de dias)
...
COMMENT ON FUNCTION get_correction_status(UUID, INTEGER, INTEGER) IS 'Verifica se um funcionário pode fazer correções de ponto em um determinado mês/ano - CORRIGIDO: erro de EXTRACT';
