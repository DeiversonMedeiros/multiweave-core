-- =====================================================
-- CORREÇÃO SIMPLIFICADA DA FUNÇÃO get_entity_data
-- Data: 2025-01-20
-- Descrição: Versão simplificada e robusta da função get_entity_data
-- =====================================================
...
BEGIN
    ...
    -- Construir cláusula WHERE básica
    ...
    -- Adicionar filtros dinâmicos do JSON de forma mais segura
    IF filters IS NOT NULL AND jsonb_typeof(filters) = 'object' THEN
        ...
        LOOP
            ...
            IF filter_value IS NOT NULL AND filter_value != '' AND filter_value != 'all' THEN
                -- Construir condição de forma mais segura
                condition := '';
                ...
                -- Adicionar condição se foi construída
                IF condition != '' THEN
        ...
        -- Adicionar todas as condições de filtro
