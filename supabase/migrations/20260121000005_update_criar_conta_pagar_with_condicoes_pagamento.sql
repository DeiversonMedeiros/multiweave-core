-- =====================================================
-- MIGRAÇÃO: Atualizar função criar_conta_pagar para incluir condições de pagamento e parcelamento
-- Data: 2026-01-21
-- Descrição: Atualiza a função compras.criar_conta_pagar para:
--            1. Incluir condições de pagamento do pedido
--            2. Vincular pedido_id na conta
--            3. Criar parcelas automaticamente se is_parcelada = true
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE '[criar_conta_pagar] ✅ Conta criada: conta_id=%, pedido_id=%, forma_pagamento=%, is_parcelada=%, numero_parcelas=%', 
        v_conta_id, p_pedido_id, v_forma_pagamento, v_is_parcelada, v_numero_parcelas;
...
'Cria conta a pagar automaticamente quando pedido é criado. Inclui condições de pagamento, vinculação com pedido_id e criação automática de parcelas se is_parcelada = true.';
