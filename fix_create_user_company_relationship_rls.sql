-- =====================================================
-- CORREÇÃO: Desabilitar RLS temporariamente na função
-- =====================================================
-- Este script corrige o problema de RLS bloqueando a inserção
-- na função create_user_company_relationship

-- Recriar a função com RLS desabilitado temporariamente
...
COMMENT ON FUNCTION public.create_user_company_relationship(UUID, UUID, UUID) IS 
  'Cria ou atualiza o relacionamento entre um usuário e uma empresa com um perfil específico. Usa SECURITY DEFINER e desabilita RLS temporariamente para permitir execução pela edge function.';
