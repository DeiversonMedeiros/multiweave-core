-- =====================================================
-- MELHORAR FUNÇÃO calculate_night_hours
-- =====================================================
-- Data: 2026-01-28
-- Descrição: Adiciona parâmetros opcionais de data para entrada e saída
--            para permitir cálculo preciso de horas noturnas quando registros
--            cruzam meia-noite.
-- =====================================================

-- Remover função antiga (sem parâmetros de data)
DROP FUNCTION IF EXISTS rh.calculate_night_hours(TIME, TIME, DATE);
...
-- =====================================================
-- ATUALIZAR calculate_overtime_by_scale para usar datas
-- =====================================================
-- Atualizar a função para buscar campos *_date e passar para calculate_night_hours
