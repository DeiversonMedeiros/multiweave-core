-- =====================================================
-- ADICIONAR CAMPO NUMERO_NOTA_FISCAL À FUNÇÃO RPC
-- =====================================================
-- Data: 2025-12-20
-- Descrição: Adiciona campo numero_nota_fiscal à função list_contas_pagar_with_approval_status
...
COMMENT ON FUNCTION public.list_contas_pagar_with_approval_status(UUID) IS 'Lista contas a pagar com status de aprovação agregado e campos de parcelamento/urgência. Atualizada em 2025-12-20 para incluir numero_nota_fiscal.';
