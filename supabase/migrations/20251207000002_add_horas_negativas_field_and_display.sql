-- =====================================================
-- ADICIONAR CAMPO horas_negativas E ATUALIZAR FUNÇÃO
-- Para exibir horas negativas quando trabalhou menos que o esperado
-- =====================================================

-- Adicionar campo horas_negativas na tabela time_records
ALTER TABLE rh.time_records 
ADD COLUMN IF NOT EXISTS horas_negativas DECIMAL(4,2) DEFAULT 0;

COMMENT ON COLUMN rh.time_records.horas_negativas IS 
  'Horas negativas quando o funcionário trabalhou menos que o esperado no dia. 
   Diferente de horas_faltas que é para faltas justificadas.';

-- Atualizar função calculate_overtime_by_scale para calcular horas negativas
...
BEGIN
  ...
  -- Se negativo, calcular horas negativas
  ...
  ELSIF v_excedente < 0 THEN
    -- Trabalhou menos que o esperado: calcular horas negativas
