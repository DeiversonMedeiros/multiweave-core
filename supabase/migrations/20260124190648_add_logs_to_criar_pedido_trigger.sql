-- =====================================================
-- FIX: Adicionar logs detalhados na função criar_pedido_apos_aprovacao_cotacao_ciclos
-- Data: 2026-01-24
-- Descrição: Adiciona logs detalhados e tratamento de erros na chamada
--            de criar_conta_pagar para facilitar diagnóstico.
-- =====================================================
...
'Cria pedido e conta a pagar ao aprovar cotação. Usa fornecedores VENCEDORES (is_vencedor em cotacao_item_fornecedor), não cf.status. Totais e itens apenas dos itens vencedores por fornecedor. Atualizado em 2026-01-24 com logs detalhados e tratamento de erros.';
