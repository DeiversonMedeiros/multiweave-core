-- =====================================================
-- CORREÇÃO: Erro "row expansion via '*' is not supported here"
-- Data: 2025-01-17
-- Descrição: Corrige a função record_edit_and_reset_approvals para evitar
--            o uso de (ROW(OLD.*)).* que não é suportado no PostgreSQL
-- =====================================================

-- =====================================================
-- FUNÇÃO CORRIGIDA: record_edit_and_reset_approvals
-- =====================================================
-- Esta versão evita o uso de row expansion e compara campos individualmente
...
BEGIN
    ...
    -- Resetar aprovações se a solicitação não estiver cancelada/reprovada
    ...
    CASE processo_tipo
        WHEN 'requisicao_compra' THEN
            ...
            -- Não resetar se estiver cancelada
...
'Registra edições e reseta aprovações quando há mudanças significativas. Evita row expansion usando comparação campo por campo.';
