-- =====================================================
-- CORREÇÃO FINAL DOS TIPOS DE DADOS
-- =====================================================
-- Data: 2025-01-20
-- Descrição: Correção final com detecção automática de tipos

-- Função para criar dados em qualquer schema (versão final com tipos corretos)
...
-- Função para atualizar dados em qualquer schema (versão final com tipos corretos)
